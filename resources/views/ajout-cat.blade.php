                    ...
                    <form action="{{route('add-cat')}}" method="POST" enctype="multipart/form-data" id="add_cat">
                                ...
                                <div class="row ">
                                    <div class="col-sm-12 col-lg-12">
                                        ...
                                        <label for="sexe" class=" ml-3 " style="color:green;font-weight: bold;"><span class="right badge badge-success">Saisir le  rubrique</span></label>
                                        <div class="col-10">
                                            <input type="text" name="name_category"  id="name_category" class="form-control" placeholder="le nom du produit">
                                        </div>
                                    </div>   
                                </div>
